...
describe('Vocabulary tests', function () {
    ...
    it('can query vocabularies by session id', async () => {
    ...
    it('can query vocabularies by data source', async () => {
    ...
    it('can get words for a vocabulary', async () => {
    ...
    it('can filter words by type', async () => {
